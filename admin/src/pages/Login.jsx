...
function Login() {
  ...
  return (
    <div className='w-[100vw] h-[100vw] bg-gradient-to-l from-[#141414] to-[#0c2025] text-[white] flex flex-col items-center justify-start'>
             ...
             px-[30px] gap-[10px] cursor-pointer'>
              ...
              <div className='w-[100%] h-[80px] flex items-center justify-center flex-col gap-[10px]'>
                 ...
                 <span className='text-[16px] '>Welcome to Kiswa,Apply to Admin Login</span>
             </div>
             ...
             shadow-lg flex items-center justify-center'>
                 <form action=""  onSubmit={AdminLogin} className='w-[90%] h-[90%] flex flex-col items-center justify-start gap-[20px]'>
                          ...
                          <div className='h-[90%] h-[400px] flex flex-col items-center justify-center gap-[15px] relative'>
                             ...
                             {!show && <IoEyeOutline className='w-[18px] h-[18px] cursor-pointer absolute right-[10%] bottom-[50%]'
                             onClick={()=>setShow(prev => !prev)}/>}
                             {show && <IoEye className='w-[18px] h-[18px] cursor-pointer absolute right-[10%] bottom-[50%]'
                             onClick={()=>setShow(prev =>!prev)}/>}
