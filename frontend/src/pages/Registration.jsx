            ...
            <form action="" onSubmit={handleSignup} className='w-[90%] h-[90%] flex flex-col items-center justify-start gap-[20px]'>
                <div className='w-[90%] bg-[#42656cae] rounded-lg flex items-center justify-center gap-[10px] py-[20px]
                 cursor-pointer' onClick={googleSignup}>
                    <img src={google} alt="" className='w-[20px]'/> Registration with Google</div>
                    ...
                    <div className='w-[40%] h-[1px] bg-[#96969635]'></div><span>OR</span><div className='w-[40%] h-[1px] bg-[#96969635]'></div>
                     ...
                     <div className='h-[90%] h-[400px] flex flex-col items-center justify-center gap-[15px]' relative>
                        ...
                        {!show && <IoEyeOutline className='w-[18px] h-[18px] cursor-pointer absolute right-[43%]'
                        onClick={()=>setShow(prev => !prev)}/>}
                        {show && <IoEye className='w-[18px] h-[18px] cursor-pointer absolute right-[43%]'
                        onClick={()=>setShow(prev =>!prev)}/>}
                        ...
                        <p className='flex gap-[10px]'>Already have an account?<span className='text-[#55556fcf] text-[17px] 
